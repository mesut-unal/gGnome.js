  ...
  <nav id="navbar" class="navbar navbar-default" role="navigation">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="./index.html">gGnome.js</a>
      </div>
      <form class="navbar-form navbar-left" role="search">
        <div class="form-group">
          <div id="tags-selector" class="ui floating selection labeled search fluid scrolling multiple dropdown">
            <i class="filter icon"></i>
            <div class="default text">Browse categories</div>
            <div class="menu"></div>
          </div>
        </div>
        <div class="form-group marleft10">
         <span class="counter-label"></span>
        </div>
        <div class="form-group marleft10">
          <select id="data-selector" class="ui floating fluid search selection dropdown data-selector"></select>
        </div>
      ...
      <form class="navbar-form navbar-right" role="search">
        ...
        <div class="form-group marleft20">
          <div class="content checkbox-container">
            <div id="checkbox_genes" class="ui checkbox">
              <input type="checkbox" name="genes">
              <label>Genes</label>
            </div>
            <div id="checkbox_walks" class="ui checkbox">
              <input type="checkbox" name="walks">
              <label>Walks</label>
            </div>
            <div id="checkbox_coverage" class="ui checkbox">
              <input type="checkbox" name="coverage">
              <label class="scatterplot">Coverage</label>
            </div>
            <div id="checkbox_rpkm" class="ui checkbox">
              <input type="checkbox" name="rpkm">
              <label class="barplot">RPKM</label>
            </div>
          </div>
        </div>
      </form>
...
#subprocess.run(['bash','/Users/munal/Desktop/Graph/gGnome.js/start.sh'])
